...
// Fetch products added by the seller with category names
$seller_id = $_SESSION['id'];
$sql_products = "SELECT p.*, c.name AS category_name FROM products p INNER JOIN categories c ON p.CategoryID = c.id WHERE SellerID = ?";
