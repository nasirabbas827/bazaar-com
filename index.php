...
$sql_products = "SELECT p.*, c.name AS category_name, s.StoreName, s.Location FROM products p 
...
<div class="jumbotron text-center">
    <h1>Welcome to our Online Buy and Sell Platform</h1>
...
<div class="container mt-5">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <?php
                                $discount_price = $row['Price'] - ($row['Price'] * 0.05);
                                echo '<p class="card-text text-danger"><strong>Discount Price:</strong> $' . number_format($discount_price, 2) . '(For Registered Users only)</p>';
                                ?>
  ...
  <div class="container">
    ...
    <div class="row mt-3">
      <div class="col">
        <p class="text-center mb-0">&copy; 2024 Your Online Bazaar.com Project. All rights reserved.</p>
      </div>
    </div>
  </div>
</footer>
