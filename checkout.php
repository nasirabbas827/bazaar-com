...
// Initialize variables for email and user id
$user_email = '';

// Check if user is logged in
if (isset($_SESSION["id"])) {
    // If logged in, fetch the user's email from the session
    $user_email = $_SESSION["email"];
} else {
    // If not logged in, set the email to an empty string
    $user_email = '';
}
...
$total_price_with_discount = $total_price; // Remove discount
