...
// Check if total price, delivery address, and email are provided
if (!isset($_POST['total_price']) || !isset($_POST['delivery_address']) || !isset($_POST['email'])) {
...
$sql_insert_order = "INSERT INTO visitor_orders (username, TotalPrice, DeliveryAddress, OrderStatus) 
                     VALUES ('$username', '$total_price', '$delivery_address', 'Pending')";
...
if (mysqli_query($conn, $sql_insert_order)) {
    ...
    foreach ($_SESSION['cart'] as $item) {
        ...
        $sql_insert_order_item = "INSERT INTO visitor_order_items (OrderID, ProductID, Quantity) 
